...
const INQUIRY_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: "demo", label: "Artist / demo submission" },
...
const CONTACT_FIELD_ORDER: (keyof ContactFormState)[] = [
  "name",
  "email",
  "subject",
  "message",
...
function ContactSection() {
  const [form, setForm] = useState<ContactFormState>(INITIAL_CONTACT);
  const [submitted, setSubmitted] = useState(false);
  const [errors, setErrors] = useState<Partial<Record<keyof ContactFormState, string>>>({});
  const fieldRefs = useRef<Partial<Record<keyof ContactFormState, HTMLInputElement | HTMLTextAreaElement | null>>>({});
  ...
  function validate(): Partial<Record<keyof ContactFormState, string>> {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    const firstInvalid = CONTACT_FIELD_ORDER.find((k) => next[k]);
    if (firstInvalid) {
    ...
    <section className="contact" id="contact">
      <div className="contact-inner">
        <div className="contact-info">
          ...
          <h2 className="contact-headline">LET'S MAKE SOMETHING.</h2>
          <p className="contact-lede">
            Whether you're an artist, journalist, brand, or collaborator —
            we'd love to hear from you. Fill out the form and the right
            person on our team will reply within a few business days.
          </p>
          <div className="contact-meta">
            ...
            <div className="contact-meta-row">
              <div className="contact-meta-label">FOLLOW</div>
              <div className="contact-socials">
                <a href="https://www.facebook.com/jbrcreativegroup1/" target="_blank" rel="noopener noreferrer">Facebook</a>
                <span aria-hidden="true">·</span>
                <a href="https://joeleone.lnk.to/music" target="_blank" rel="noopener noreferrer">Joe Leone</a>
                <span aria-hidden="true">·</span>
                <a href="https://ericbenet.lnk.to/music" target="_blank" rel="noopener noreferrer">Eric Benét</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="contact-form-wrap">
          {submitted ? (
            <div className="contact-success" role="status" aria-live="polite">
              ...
              <h3>MESSAGE SENT.</h3>
              <p>
                Thanks, {form.name.split(" ")[0] || "friend"} — we've got
                your note and will be in touch soon.
              </p>
            ...
            <form className="contact-form" onSubmit={handleSubmit} noValidate>
              <div
                className={`contact-form-summary${errorCount > 0 ? " is-visible" : ""}`}
                role="alert"
                aria-live="assertive"
              >
                {errorCount > 0 && (
                  <>Please fix {errorCount} {errorCount === 1 ? "field" : "fields"} below to send your message.</>
                )}
              </div>
              ...
              <div className="contact-row contact-row-2">
                <label className="contact-field">
                  ...
                  />
                  {errors.name && <span className="contact-error" id="err-name">{errors.name}</span>}
                </label>
                <label className="contact-field">
                  <span>Email *</span>
                  <input
                  ...
                  />
                  {errors.email && <span className="contact-error" id="err-email">{errors.email}</span>}
                </label>
              </div>
              ...
              <label className="contact-field">
                ...
                />
                {errors.subject && <span className="contact-error" id="err-subject">{errors.subject}</span>}
              </label>
              ...
              <label className="contact-field">
                ...
                />
                {errors.message && <span className="contact-error" id="err-message">{errors.message}</span>}
              </label>
