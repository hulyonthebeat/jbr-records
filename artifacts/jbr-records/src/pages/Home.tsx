...
import { ChevronRight, ChevronLeft, ArrowRight, ArrowUp, Mail, MapPin } from "lucide-react";
...
function BackToTop() {
  ...
  return (
    <button
      ...
      className={`fixed z-50 right-5 bottom-5 md:right-8 md:bottom-8 w-12 h-12 md:w-14 md:h-14 flex items-center justify-center bg-[#C7332E] text-white border border-white/20 shadow-lg shadow-black/40 transition-all duration-300 hover:bg-[#a82923] focus:outline-none focus:ring-2 focus:ring-white/60 ${
